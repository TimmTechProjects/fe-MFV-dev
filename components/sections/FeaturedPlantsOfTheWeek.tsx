              ...
              >
                <div className="rounded-2xl overflow-hidden bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#81a308]/30 h-full flex flex-col">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <Link
                      href={plantUrl}
                      className="mt-3 inline-flex items-center justify-center bg-[#81a308]/10 hover:bg-[#81a308] text-[#81a308] hover:text-white font-medium py-1 px-2.5 sm:py-1.5 sm:px-3 rounded-xl text-[10px] sm:text-xs transition-all duration-200"
                    >
                      View Details
                    </Link>
                  </div>
